...
Gem::Specification.new do |s|
  ...
  s.authors = ['Thiyagarajan Veluchamy']
  s.email = 'thiyagarajannv@yahoo.com'
  s.files = ['lib/userextension/user_extension.rb', 'lib/selenium-framework.rb', 'bin/copyfiles/Gemfile', 'bin/copyfiles/selenium-framework.yml', 'bin/copyfiles/include.rb', 'bin/copyfiles/project_file.rb', 'lib/userextension/pre_requisite.rb', 'lib/userextension/utilities.rb', 'bin/testdata/sample.avi', 'bin/testdata/sample.bmp', 'bin/testdata/sample.flv', 'bin/testdata/sample.gif', 'bin/testdata/sample.jpeg', 'bin/testdata/sample.mp4', 'bin/testdata/sample.pdf', 'bin/testdata/sample.png', 'bin/testdata/sample.txt', 'bin/testdata/sample.wmv', 'bin/testdata/sample.xml']
  s.require_path = 'lib'
